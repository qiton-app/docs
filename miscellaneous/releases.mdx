...
<Update label="v0.9.0" description="13 may 2025">
    <Frame>
        <img
            ...
            src="./images/releases/players_scouting.png"
            alt="Players scouting feature"
        />
        <img
    ...
    The Players scouting feature is now available, enabling you to compare players using intricate filters on
    statistics.
</Update>
