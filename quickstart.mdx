...
Esports teams get access to indigest data under the format of JSONLs (20,000+ lines each). This ecosystem is still young,
and teams often don't have the budget to hire experienced developers to handle all of this data.
