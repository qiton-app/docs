...
<Tabs>
    <Tab title="Metrics">
        Metrics score is a composite performance rating calculated by normalizing and weighting various statistics based
        on a predefined preset. It produces a final score between 0 and 100, reflecting the overall effectiveness of a
        player in a match or series.
