...
<Update label="v2.2.0" description="February 03, 2026">
    <Frame>
        <img
            src="./images/releases/similar-rounds.png"
            alt="First Qiton's AI-powered feature"
        />
    </Frame>
    Qiton is introducing its first AI-powered feature, which allows coaches to find similar rounds in one click.
    Learn more [here](/core/match/replay/similar-rounds).
</Update>

<Update label="v2.1.0" description="February 03, 2026">
    New `Distance traveled winrate` component released.
    Learn more [here](/core/map/overview/distance-traveled-winrate).
</Update>
...
<Update label="v2.0.0" description="February 02, 2026">
    <Frame>
        <img
            ...
            alt="Qiton has won the 2026 Epitech Experience"
        />
    </Frame>
