...
In the first place click on the **Rewind** button, and you will be redirected.
...
- `Players' positions`
- `Players' aiming directions and visions`
- `Abilities used`
- `Kills positions`
- `ORBs positions`
- `Spike position`
...
- `Team score`
- `Enable or disable player's vision`
- `Player's name`
- `Agent's name`
...
This section showcases all events including kills, spike, abilities and ORBs for the selected round.
